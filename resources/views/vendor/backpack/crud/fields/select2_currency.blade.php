...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <select
        ...
        @if (isset($field['default_currency']) and isset($field['default_currency_id']))
            <option value= {{$field['default_currency_id']}} >{{$field['default_currency']}}</option>      
        ...
        @endif
            ...
            @if (isset($field['model']))
                @foreach ($field['model']::all() as $connected_entity_entry)
                    @if ( $connected_entity_entry->getKey() != $field['default_currency_id'])
